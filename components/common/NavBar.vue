<template>
  <nav class="fixed w-full p-6 md:px-20 bg-gray-900">
    <div class="flex items-center">
      ...
      <div class="hidden md:block">
        <ul class="flex space-x-8 text-md font-sans font-semibold">
          ...
          <li><a href="#" class="hover:border-b-2 hover:border-blue-500">Services</a></li>
          <li><a href="#" class="hover:border-b-2 hover:border-blue-500">Features</a></li>
          <li><a href="#" class="hover:border-b-2 hover:border-blue-500">FAQ</a></li>
          <li><a href="#" class="hover:border-b-2 hover:border-blue-500">Contact</a></li>
